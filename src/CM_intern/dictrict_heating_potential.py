...
import osr
import numpy as np
from scipy.ndimage import measurements, binary_fill_holes, binary_dilation, binary_erosion
...
def DHRegions(DH, DH_threshold):
    ...
    # expansion and erosion of the connected components in order to connect different components which are in close vicinity of each other
