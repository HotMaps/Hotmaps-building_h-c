...
def match(inputCSV1, inputCSV2, inputCSV3, specificDemand, areaThreshold, outputCSV):
            ...
            for address in addresses:
                ...
                if flag == 1:
                    ...
                    if True in temp4:
                        ...
                        Footprint_Access[i] = footprint1[temp5[0]]
                        GArt[i] = GEBAEUDEART1[temp5[0]]
                        flag = 0
                        flag1 = 1
                    else:
                        temp4 = np.absolute(footprint1[EqCases] - Footprint[i]) < areaThreshold
                        if True in temp4:
                            temp5 = EqCases[temp4]
                            FloorNr_Access[i] = FloorNr1[temp5[0]]
                            GIndex_Access[i] = GINDEX1[temp5[0]]
    ...
    spec_dem = demand_typ[GArt].astype(float)
    ...
    col = ["ID", "GIndex_Access", "Ortsbezirk_Nr", "Stadtteil_Nr", "Stadtbezirk_Nr", \
           ...
           "GArt", "KGF", "OBJ", "Footprint", "Footprint_Access", "NrFloor", "FloorNr_Access", "GFA", "Spec_Demand", "X", "Y"]
...
if __name__ == "__main__":
    ...
    outputCSV1 = "/home/simulant/ag_lukas/personen/Mostafa/Frankfurt Buildingblocks/Frankfurt_matched_th2.csv"
    outputCSV2 = "/home/simulant/ag_lukas/personen/Mostafa/Frankfurt Buildingblocks/Frankfurt_matched_th5.csv"
    match(inputCSV1, inputCSV2, inputCSV3, specificDemand, 2, outputCSV1)
    #match(inputCSV1, inputCSV2, inputCSV3, specificDemand, 5, outputCSV2)
