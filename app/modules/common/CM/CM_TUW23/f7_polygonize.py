...
def add_label_field(dh_bool_raster, label_raster, outPolygon, economic,
                    heat_dem_coh, heat_dem_spec_area, q, q_spec_cost,
                    area_coh_area, epsg=3035):
    label_list = []
...
def polygonize(dh_bool_raster, label_raster, outPolygon, economic,
               heat_dem_coh, heat_dem_spec_area, q, q_spec_cost,
               area_coh_area, epsg=3035):
    ...
    add_label_field(dh_bool_raster, label_raster, outPolygon, economic,
                    heat_dem_coh, heat_dem_spec_area, q, q_spec_cost,
                    area_coh_area)
